...
candidateList.stream().filter(c ->  c.getCity().equalsIgnoreCase("Pune")).
		...
		countPerCity.forEach((a,b) -> System.out.println(a+" -- "+b+"  time"));
		System.out.println("--------------------------------");
		...
		candidateList.stream().filter(c -> c.getYearsOfExperience() == 0).
			forEach(System.out::println);
		System.out.println("--------------------------------");
		
		// listing candidates with highest experience
		System.out.println("\nSorted List of Candidates by Experience\n");
		candidateList.stream().sorted((a1,a2) -> 
			(a1.getYearsOfExperience()-a2.getYearsOfExperience()))
			.forEach(System.out::println);
		...
		candidateList.stream().sorted((a1,a2) -> a1.getCity().compareTo(a2.getCity()))
		.forEach(System.out::println);
		System.out.println("--------------------------------");
	}
